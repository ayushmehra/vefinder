...
<html lang="en">
    ...
    <head><?php include VIEWPATH . 'common/HeaderScript_HTML.php'; ?>
        ...
        <style>
            ...
            //.vf-comments-popup-section{background-color: rgba(0, 0, 0, 1) !important;}
        </style>
        <script>
	...
	?>
        <div id="wrapper" style="min-height: 0 !important;">
            ...
            <div id="Header">
                ...
                <?php include VIEWPATH.'common/CommentsPopupEventPage_HTML.php'; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 action-menus">
                                        ...
                                        <div class="row action-items">
                                            ...
                                            <div class="col-xs-3">
                                                <?php echo $fb_Share;?><img src="./assets/images/share-icon.png" />
                                            </div>
                                            <div class="col-xs-3">

							...
							<div class="col-sm-10">
									<form name="product" id="product"  method="POST" enctype="multipart/form-data">
										...
										<div class="col-sm-12 post-form-container">
											...
											<div class="col-sm-12">
												...
												<div class="col-sm-5">
													<input type="number" class="post-form-input validate[required,custom[integer]]" value="<?php echo $product->product_stock;?>" name="stock" placeholder="Number of items in stock" />
												</div>
											</div>
										</div>
											...
											<div class="col-sm-12 padding-bottom20">
												...
												<div class="col-sm-5">
													<div class="radio-inline">
														<input id="checkbox3" type="radio" name="bid" value="2" class="post-form-checkbox Bid-Enable" checked> Biding Enable
													</div>
												</div>
											</div>
											<div class="col-sm-12 padding-bottom20">
										...
										<div class="col-sm-12 padding-top20"></div>
											...
											<div class="col-sm-12 post-form-container">
												<div class="col-sm-12 padding-bottom20">
													...
													<div class="col-sm-5">
														<input type="number" class="post-form-input" name="bid_limit" value="<?php echo $product->bid_limit ;?>" placeholder="Enter minimum biding amount" />
													</div>
												</div>
												<div class="col-sm-12 padding-bottom20">
													<div class="col-sm-1">
													...
													<div class="col-sm-5">
														<input type="text" class="post-form-input validate[required,custom[date]]" data-provide="datepicker" value="<?php echo $product->bid_startDate; ?>" id="signupDOBTxt" name="bid_startDate" />
													</div>
													<div class="col-sm-1">
														<label class="post-form-label">
															Biding End Date
													...
													<div class="col-sm-5">
														<input type="text" class="post-form-input validate[required,custom[date]]" data-provide="datepicker" value="<?php echo $product->bid_endDate;?>" id="signupDOBTxt2" name="bid_endDate" />
													</div>
												</div>
												<div class="col-sm-12 padding-bottom20">
													<div class="col-sm-1">
													...
													<div class="col-sm-5">
														<input type="text" class="post-form-input clockpicker validate[required] " id="bid_startTime" value="<?php echo $product->bid_startTime;?>" name="bid_startTime"  />
													</div>
													<div class="col-sm-1">
														<label class="post-form-label">
															Biding End Time
													...
													<div class="col-sm-5">
														<input type="text" class="post-form-input clockpicker2 validate[required] " id="bid_endTime" value="<?php echo $product->bid_endTime;?>" name="bid_endTime"/>
													</div>
												</div>
											</div>
											<div class="col-sm-12 padding-top20"></div>
										...
										<div class="col-sm-12 post-form-container">
											<div class="col-sm-12 padding-bottom20">
												...
												<div class="col-sm-5">
													<input type="number" class="post-form-input validate[required]" value="<?php echo $product->shipping_fee; ?>" name="shipping_fee" placeholder="Enter Price" />
												</div>
											</div>
											<div class="col-sm-12">
												<div class="col-sm-1">
									...
									<div class="col-sm-12">
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-4"></div>
											<div class="col-sm-4">
												<input type="submit" id="submit_product" name='submit' value="Edit Bid Product" class="hm-item-btn-lg">
											</div>
										</div>
									</form>
							</div>

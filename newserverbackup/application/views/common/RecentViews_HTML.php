            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <h5 class="vf-item-slider-section-heading">
                        Your recent views&nbsp;&nbsp;
                        <a href="<?php echo base_url();?>Home/Browsing-History">
                            View All
							&nbsp;&nbsp;
                ...
                <div class="col-sm-12">
                    <div id="carousel-item-2" class="carousel slide" data-ride="carousel" data-interval="5000">
                        <!-- Wrapper for slides -->
                        <div class="carousel-inner" role="listbox">						
                            <?php 
							//print_r($browsing_history); 
							
							foreach($browsing_history as $value){ 
							$text=	chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90));
								...
								if($i==0){ ?> <div class="item active"><div class="col-sm-1"></div><div class="col-sm-10"> <? } ?>
                                        ...
                                        <div class="col-sm-12 hm-item-container">
                                            ...
                                            <div class="col-sm-12 padding-top15" align="center">
                                                <ul class="hm-item-icon">
                                                    <li class="slider-product home-like" data-from="recent" data-val="<?php echo base64_encode($value->product_id);?>" data-my="<?php echo $value->product_id;?>" id="change-<?php echo $value ->product_id; ?>">
									...
									<?php $i++;   $star_tag='';
									if(($i%4==0)&&($i!=count($browsing_history))){?></div><div class="col-sm-1"></div></div><div class="item"><div class="col-sm-1"></div><div class="col-sm-10"> <?php } ?>
								<?php  }  ?>
								</div><div class="col-sm-1"></div></div>
						</div>
                        <!-- Controls -->
                        <?php if(count($browsing_history)>4){ ?>
							<a id="itemRecentLeftSlide" class="left carousel-control top-50per" href="#carousel-item-2" role="button" data-slide="prev">
								<img src="<?php echo base_url();?>assets/images/slide-left-icon.png" />
							</a>
							<a id="itemRecentRightSlide" class="right carousel-control top-50per" href="#carousel-item-2" role="button" data-slide="next">

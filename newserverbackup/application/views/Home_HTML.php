...
<?php include VIEWPATH.'common/HeaderScript_HTML.php'; ?>
    <script>
        function ProductListing(value){
            window.location.href="<?php echo base_url(); ?>?sortby="+value;
        }
    </script>
<head>
<body class="home-page-body">
	...
	<?php include VIEWPATH.'common/Home_Slider_HTML.php'; ?>	
	 <section class="hm-product-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
				<?php if (@$condition=='Browsing-History'){ ?>
					<div class="col-sm-12 padding-bottom30">
                        <h4 class="vf-browsing-history-section-heading">
                            Browsing History
                        </h4>
                    </div>
				<?php } ?>
                    <div class="col-sm-12 padding-top5 padding-bottom5">
                        <label class="hm-sortby-label">Sort by</label>
						<!-- <button class="btn btn-default dropdown-toggle hm-sortby-select" id="sortByHomePage" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            Relevance
                            &nbsp;&nbsp;
                            <span>
                        ...
                        <ul class="dropdown-menu hm-sortby-select-list" aria-labelledby="dropdownMenu1">
                            <li><a href="#" class="sort-by-items" data-value="Relevance">Relevance</a></li>
                            <li><a href="#" class="sort-by-items" data-value="Recent">Recent</a></li>
							<li><a href="#" class="sort-by-items" data-value="Recent">Price(Low To High)</a></li>
							<li><a href="#" class="sort-by-items" data-value="Recent">Price(High To Low)</a></li>
                        </ul> --> 
                        <select class="hm-sortby-select" onchange="ProductListing(this.value);">
                            <option value="1" <?php if(@$_GET['sortby']=='1'){ ?>selected="selected"<?php }?>>Relevance</option>
                            <option value="2" <?php if(@$_GET['sortby']=='2'){ ?>selected="selected"<?php }?>>Recent</option>
                            <option value="3" <?php if(@$_GET['sortby']=='3'){ ?>selected="selected"<?php }?>>Price(Low To High)</option>
                            <option value="4" <?php if(@$_GET['sortby']=='4'){ ?>selected="selected"<?php }?>>Price(High To Low)</option>
                        </select>
                    </div>
...
EOT;
					...
					<?php /*
					 <div class="col-sm-12 hm-load-more-items">
                        Load more item..... 
                    </div> */?>
					<!--PAGINATION-->
					<?php if($condition!='Browsing-History'){ ?>

                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12 padding-bottom30">
                            ...
                            <div class="col-sm-6 padding-top10">
                                ...
                                <!--ITEM DESCRIPTIONS-->
                                <div class="col-sm-12 padding-top5">
                                    <a href="<?php echo base_url().'ProductFullView/'.base64_encode('dfsEWCEWETGFTEDFTEXSXSEXRXESRXESRXEXRZ').'/'.base64_encode($product->product_id).'/'. base64_encode('dfsEWCEWETGFTEDFTEXSXSEXRXESRXESRXEXRZ');?>" class="bid-item-desc">
                            ...
                            <div class="col-sm-3 padding-top20" align="center">
                                ...
                                <div class="col-sm-12 padding-top5">
                                    <p class="vf-item-sold margin-bottom0-imp">
                                       <?php echo $product->SoldItemCount; ?> Items are <a href="<?php echo base_url();?>Sold-Item-Info/<?php echo $product->product_name; ?>/<?php echo base64_encode('dfsEWCEWETGFTEDFTEXSXSEXRXESRXESRXEXRZ').'/'.base64_encode($product->product_id);?>">sold</a>
                                    </p>
                                </div>

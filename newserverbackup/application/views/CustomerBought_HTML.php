            ...
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="col-sm-12 padding-bottom30">
                        <h4 class="vf-search-section-heading">
                            <span>Customer Bought These Items Also</span>
                        </h4>
                    </div>
				<?php 
				...
				{?>	
                    <div class="col-sm-12 padding-top5 padding-bottom5">
                        ...
                        <select class="hm-sortby-select">
                            <option value="1">Relevance</option>
                            <option value="2">Recent</option>
                        </select>
                    </div> 
				<?php
					$i=1;$button='';$bid_count_and_watcher='';$bid_timer='';$download_button=''; $k=1;
					foreach($product as $product_value)
					{
						$text=	chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90)) . chr(rand(65,90));
						if($product_value->images<>'')
						{
							foreach($product_value->images as $image){
						...
						$fbimg		=		base_url().'assets/images/product/'.$imagedata;
						$fb_Share	=		<<<EOT
...
EOT;
					...
					/* <<div class="col-sm-12 padding-top5" align="center">
						...
						if($product_value->post_type==2)
						{
							...
							$button ='<div class="col-sm-12 padding-top5 padding-bottom5" align="center">
									<button class="hm-item-btn-lg" type="button">Place Bid</button>
								</div>';	
						...
						{ 
							...
							$imageWithLink	=	'<a href="'.$product_value->web_url.'" class="hm-item-name" target="_blank">
							<img src="'.base_url().'assets/images/product/'.$imagedata.'" class="img-responsive item-image" />
							<a>';
						}
						else
						{
							...
							$imageWithLink	=	'<a href="'.base_url().'ProductFullView/'.base64_encode('dfsEWCEWETGFTEDFTEXSXSEXRXESRXESRXEXRZ').'/'.base64_encode($product_value->product_id).'/'. base64_encode('dfsEWCEWETGFTEDFTEXSXSEXRXESRXESRXEXRZ').'" class="hm-item-name">
							<img src="'.base_url().'assets/images/product/'.$imagedata.'" class="img-responsive item-image" />
							<a>';
						}
                           ...
                           '.$download_button.'
                            ...
                            <div class="col-sm-6" align="right">
                                <span class="hm-item-time">
                                     '. HumanTiming($product_value->Sold_date).'
                                </span>
                            </div>

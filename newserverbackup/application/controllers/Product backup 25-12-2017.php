...
class Product extends CI_Controller 
{
    ...
    ********************************************/
	...
	function Edit_Product($garbage,$key,$garbage1,$com='')
	{
		...
		if($data['product']->post_type==3)
		{
			if(@$_REQUEST['submit'] == 'Edit Advertisement')
			{
				...
				$data['Submit_Product']= $this->Product_model->EditAd($product_name,$cat_id,$product_description,$web_url,
											$image1_name,$image2_name,$image3_name,$image4_name,$product_id);
			}
			$data['product']	=	$this->Product_model->GetSingleProduct($product_id);
			$this->load->view('Edit_Ad_Product_HTML',$data);
		}
	}
}